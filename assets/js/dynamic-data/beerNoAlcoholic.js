...
fetch(
  `${API_URL}/admin/brands?:brand_articles=1&brand_category_id=2&:brand_images=1&is_published=1`,
  {
    method: 'GET',
  }
)
  .then((res) => {
    res.json().then((res) => {
      ...
      const mobileView = data
        .map((brand) => {
          return `
                <div class="swiper-slide flex-min-height-100vh mobbeerslide_height" style="background-image: url(${
                  brand.hero_image_url
                });">
                    <div class="js-parallax-slide-bg"></div>
                    <div class="flex-min-height-100vh__inner lines-container no-lines" data-swiper-parallax-x="" style="background: url(${
                      brand.hero_image_url
                        ...
                        <div class="flex-container padding-top-bottom-120 ">
                            ...
                            <div class="twelve-columns column-50-100  padding-bottom-30">
                                <h2 class="headline-xl headline-xl-mob" style="font-size: 45px; text-align:center; line-height: 45px;">
        ...
        .map((brand) => {
          return `
                    ...
                    <div class="swiper-slide flex-min-height-100vh">
                        <!-- slide-bg -->
                        <div class="js-parallax-slide-bg bg-img-cover" style="background-image: url(${
                          brand.hero_image_url
            ...
            <ul class="list list_center list_margin-20px hidden-box">
                <li class="list__item">
                    <div class="hidden-box d-inline-block">
                        <a href="https://www.facebook.com/SenqMalt"  target="_blank" class=" js-pointer-small">
                ...
                <li class="list__item">
                    <div class="hidden-box d-inline-block">
                        <a href="https://www.instagram.com/senqmalt/" target="_blank" class="  js-pointer-small">
                ...
                <li class="list__item">
                    <div class="hidden-box d-inline-block">
                        <a href="https://vm.tiktok.com/ZM8HkA8sP"  target="_blank"
                            ...
                            <div class="container padding-top-bottom-30">
                                <div class="flex-container padding-top-bottom-120 ">
                                    <div class="four-columns column-50-100  padding-top-bottom-120" style="padding-left: 40px;">
                                        ...
                                        <h2 class="headline-xl headline-xl-mob" style="font-size: 45px; line-height: 45px;">
                                            <span class="text-color-black" style="color: ${
                                              brand.text_color !=
                                              null
                                                ? brand.text_color
      ...
      document.getElementById(
        'mobile_view'
      ).innerHTML = mobileView;
      document.getElementById(
        'desktop_view'
      ).innerHTML = desktopView;
...
form.addEventListener('submit', function (e) {
  ...
  fetch(
    `${API_URL}/admin/subscribe?:limit=1&offset=0`,
    {
      method: 'POST',
      body: JSON.stringify({
        email: email,
